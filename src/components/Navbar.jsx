    ...
    <div className='flex items-center justify-between py-5 font medium'>
        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
            ...
            <NavLink to='/collection' className='flex flex-col items-center gap-1'>
                <p className='text-center'>PRODUCTS COLLECTION</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'/>
            </NavLink>
            <NavLink to='/photos' className='flex flex-col items-center gap-1'>
                <p className='text-center'>PHOTO SALES</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'/>
            </NavLink>
            ...
            <NavLink to='/membership' className='flex flex-col items-center gap-1'>
                <p className='text-center'>EXCLUSIVE MEMBERSHIP</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'/>
            </NavLink>
        ...
        {/* Mobile menu, para pantallas más pequeñas */}
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
            <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 border' to='/photos'>PHOTO SALES</NavLink>
                    ...
                    <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 border' to='/membership'>EXCLUSIVE MEMBERSHIP</NavLink>
