  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        <img className='w-full md:max-w-[450px]' src={assets.membership} alt="" />
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Standard Plan</b>
          <p className='text-gray-600'>  Our standard plan allows to every member to enjoy all the benefits of a Scarface Member for 3 Months!!
          </p>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Premium Plan</b>
          <p className='text-gray-600'> Our Premium plan allows to every member to enjoy all the benefits of a Scarface Member for 6 Months!!
          </p>
